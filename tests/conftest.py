...
# WARNING: Ensure imports from `gmap_fastapi` comes after this line
from gmap_fastapi import app, settings, db  # noqa
from gmap_fastapi.cli import create_user, cli  # noqa
